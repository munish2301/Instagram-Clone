    ...
    <Provider store={store}>
      <NavigationContainer >
        <Stack.Navigator initialRouteName="Main">
          ...
          <Stack.Screen key={Date.now()} name="Chat" component={ChatScreen} navigation={props.navigation} />
          <Stack.Screen key={Date.now()} name="ChatList" component={ChatListScreen} navigation={props.navigation} />
